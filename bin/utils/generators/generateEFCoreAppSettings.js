 ...
 */
export function generateEFCoreAppSettings(options) {
    return {
        ConnectionStrings: {
            DefaultConnection: "Server=localhost;Database=MyAppDb;User Id=sa;Password=Your_password123;TrustServerCertificate=True;",
        },
        EFCore: {
